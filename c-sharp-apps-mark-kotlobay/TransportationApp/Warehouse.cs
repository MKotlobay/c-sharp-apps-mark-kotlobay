...
namespace c_sharp_apps_mark_kotlobay.TransportationApp
{
    public class Warehouse : StorageStructure
    {
        ...
        public Warehouse(string country, string city, string street, int number, double maxCapacityWeight, double maxCapacityVolume, string name, int numWarehouse, List<IPortable> itemsFromCargo)
